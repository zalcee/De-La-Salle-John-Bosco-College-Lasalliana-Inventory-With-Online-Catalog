<?php 
	$header = "VCAAS(Human Resource Development Office)";
	...
	$category_type_id = 58;
	$address_link = "VICE-CHANCELLOR_ADMINISTRATIVE_AFFAIRS_&_SERVICES(Human_Resource_Development_Office).php";
	$category_number = 4;
?>
<div class="search">
	<select id="slct">
	...
	<div id="head">		
		<h1 style="color:white; ">+</h1>				
			...
			<ul>
				...
				<li>
					<a href="../archive.php">Back to Category</a>
				</li>
