<?php 
	...
	$category_type_id = 28;
	$address_link = "provincialate.php";
	
	$category_sub_type_id = 20;
?>
<div class="search">
	...
	<div id="head">		
		<h1 style="color:white; ">+</h1>				
			...
			<ul>
				...
				<li>
					<a href="../../souvenirs_and_programs.php">Back to Category</a>
				</li>
				
				<li>
					<a href="../print.php?page=
					<?php if (!isset($_GET["page"])){ $page = ($_GET["page"]=1);} else { $page = $_GET["page"]; } echo $page;?>&category_sub_type_id=<?php echo $category_sub_type_id; ?> " target="_blank" id="printThis">print</a>
				</li>
				<li>
					<a href="../print2.php?category_sub_type_id=<?php echo $category_sub_type_id; ?>" target="_blank">print all</a>
				</li>
